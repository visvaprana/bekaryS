        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              <form action="{{route('admin/filter-order')}}" method="get">
                   ...
                   <div class="row mb-5">
                      ...
                      @endif
                       ...
                       <div class="col-xl-2 col-md-2">
                          ...
                          <select class="form-control selectric" name="payment_method">
                              ...
                              <option value="{{$method->id}}" @php echo $method->id == $payment_method?'selected':'';@endphp>{{$method->title}}</option>
                              @endforeach
                          </select>
                      </div>
                      {{-- <div class="col-xl-2 col-md-2">
                      ...
                      <div class="col-xl-4 col-md-4" style="text-align: end;">
                        ...
                        <a href="{{ route('admin/print_order_report', ['from_date' => $from_date, 'to_date' => $to_date, 'seller_id' => $seller_id, 'invoice_id' => $invoice_id, 'payment_method' => $payment_method]) }}"><button type="button"  class="btn btn-info w-50">Print</button></a>
                    </div> 
              ...
              <p style="font-size: 25px;">Total Balance: <span style="font-weight: bold; color: red;">{{ $total_cost ?? '' }} TK.</span>	Total Cutomer Pay: <span style="font-weight: bold; color: green;">{{ $total_pay ?? '' }} TK.</span>	Total Cutomer Return: <span style="font-weight: bold; color: blue;">{{ $total_return ?? '' }} TK</span></p>
