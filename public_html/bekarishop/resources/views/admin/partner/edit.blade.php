                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-header" style="text-align: right">
                                ...
                                <a href="{{route('partner.index')}}" class="btn btn-success"> + Add New </a>
                              </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                                <form action="{{route('partner.update',$data->id)}}" method="post" enctype="multipart/form-data">
	                                ...
	                                <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="url" class="form-control" id="exampleInputEmail1" value="{{$data->url}}" >
                                        </div>

                                        <div class="form-group mt-5">
                                            <label for="exampleInputEmail1"><span class="text-danger">Partner SEO</span></label>
                                        </div>
