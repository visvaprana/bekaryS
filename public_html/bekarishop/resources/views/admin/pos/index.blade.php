                                    ...
                                    <table class="table table-striped cart-list">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <?php
                                                        $totalPrice = $sub_total;
                                                    ?>
                                                    <span>Pay:</span> <br><input type="text" name="pay" class="pay" value="" onkeyup="calculateRetun(this.value, $('#discountPercentage').val())" required>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td colspan="2">
                                                    <span>Discount Percentage:</span><br>
                                                    <div class="input-group">
                                                        <input type="text" name="discountPercentage" id="discountPercentage" class="form-control "  value="0" placeholder="Enter Discount Percentage" onkeyup="calculateRetun($('.pay').val(), this.value)">
                                                        <input type="hidden" name="discount" id="discount" class="form-control "  value="0" placeholder="Enter Discount Percentage" >
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    ...
                                                    $totalPrice = $sub_total;
                                                    ?>
                                                    <span>Return:</span><br> <input type="text" name="return" class="return" value="" readonly required>
                                                </td>
...
{{--                        if (response.success) {--}}
{{--                            $('#coupon-message').html('<span class="text-success">Coupon applied: ' + response.discount_value + ' off</span>');--}}
{{--                            $('#discount').val(response.discount_amount);--}}

{{--                            // Update total - Fix the NaN issue by ensuring proper number conversion--}}
{{--                            let currentTotal = parseFloat($('.total').val().replace(/[^\d.-]/g, '')) || 0;--}}
...
{{--                            // Recalculate return if pay amount is set--}}
{{--                            if($('.pay').val()) {--}}
{{--                                calculateRetun($('.pay').val());--}}
{{--                            }--}}
{{--                        } else {--}}
...
{{--                    },--}}
{{--                    error: function() {--}}
{{--                        $('#coupon-message').html('<span class="text-danger">Error applying coupon</span>');--}}
{{--                    },--}}
{{--                    complete: function() {--}}
