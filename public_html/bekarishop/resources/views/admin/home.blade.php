            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <?php
                    ...
                    if($admin->role_id == 1){
                        $today_sale = App\Models\Order::where( 'created_at', 'LIKE', '%' . $date .'%')->sum(DB::raw('total_cost - discount'));
                    }else {
                        $today_sale = App\Models\Order::where( 'created_at', 'LIKE', '%' . $date .'%')->where('admin_id', $admin_id)->sum(DB::raw('total_cost - discount'));
                    }

                ?>
                  <h3>{{ ($today_sale ?? 0)}} TK</h3>
