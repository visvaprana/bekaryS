    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
      ...
      ">
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item {{ request()->is('admin/filter-order-by-user') ? 'active' : '' }}">
                    <a href="{{ URL::to('admin/filter-order-by-user') }}"
                        class="nav-link {{ request()->is('admin/filter-order-by-user') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon"></i>
