        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card card-primary attribute-form">
                        @if ($errors->any())
                        ...
                        <form role="form" action="{{route('attribute.store')}}" method="post">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="Attribute Name">
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <!-- select -->
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <button data-id="{{$item->id}}" class="btn btn-primary  btn-sm editAttribute mx-1" >
                                                <span class="fa fa-edit"></span>
                                            </button>


                                            <form action="{{URL::to('admin/attribute/'.$item->id)}}" method="post">
                                                @csrf
                                                @method('DELETE')
