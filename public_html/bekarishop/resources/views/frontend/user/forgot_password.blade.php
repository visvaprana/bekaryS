...
@section('head')
    ...
    ?>
    <title> Forgot Password- {{ $site_seo->meta_title }}</title>
@endsection
@section('content')
                            ...
                            <div class="tab-pane login">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="mb-0 text-center text-bold">Verify Phone Number</h3>
                                    </div>
                                    <div class="card-body contact-from-area">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <form class="contact-form-style mt-30 mb-50" action="{{route('verify')}}" method="post">
                                                    @csrf
