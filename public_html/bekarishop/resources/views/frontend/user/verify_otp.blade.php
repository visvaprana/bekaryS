...
@section('head')
    ...
    ?>
    <title> Verify OTP - {{ $site_seo->meta_title }}</title>
@endsection
@section('content')
                            ...
                            <div class="tab-pane login">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="mb-0 text-center text-bold">Verify OTP</h3>
                                    </div>
                                    <div class="card-body contact-from-area">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <form class="contact-form-style mt-30 mb-50" action="{{route('reset-password')}}" method="post">
                                                    @csrf
                                                    <div class="input-style mb-20 w-100">
                                                        <label>OTP</label>
                                                        <input name="reset_otp" class="w-100" placeholder="Enter OTP" type="text" required="">
                                                    </div>
