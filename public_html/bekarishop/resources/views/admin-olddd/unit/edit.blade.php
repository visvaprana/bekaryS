                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-header" style="text-align: right">
                                ...
                                <a href="{{route('unit.index')}}" class="btn btn-success"> + Add New </a>
                              </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" value="{{$data->name}}" class="form-control" id="exampleInputEmail1" placeholder="Unit Name">
                                    </div>
