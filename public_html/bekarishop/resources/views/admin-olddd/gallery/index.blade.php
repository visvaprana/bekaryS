...
@section('title')
<title>{{ config('app.name') }} | Manage Gallery</title>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card card-primary gallery-form">
                        @if ($errors->any())
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <button data-id="{{$item->id}}" class="btn btn-primary  btn-sm galleyEdit mx-1" >
                                                <span class="fa fa-edit"></span>
                                            </button>


                                            <form action="{{URL::to('admin/galley/'.$item->id)}}" method="post">
                                                @csrf
                                                @method('DELETE')
