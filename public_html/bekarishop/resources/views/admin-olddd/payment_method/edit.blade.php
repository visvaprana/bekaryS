            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary banner-form">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{route('payment_method.update',$data->id)}}" method="post" enctype="multipart/form-data">
                                    @method('patch')
                                    @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="account_type" class="form-control"  value="{{$data->account_type}}">
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Image</label>
                                        @if(isset($data))
                                        <div class="form-group">
                                            <img src="{{ asset($data->image) }}" alt="Image" style=" margin-top: 8px">
