...
@section('title')
<title>{{ config('app.name') }} | Manage Post</title>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <a href="{{URL::to('admin/post/'.$item->id.'/edit')}}" title="Edit" style="float: left;margin-right: 10px;">
                                                <button type="submit" class="btn btn-primary btn-sm mx-1"><i class="fa fa-edit"></i>
                                                </button>
                                            </a>

                                            <form action="{{URL::to('admin/post/'.$item->id)}}" method="post">
                                                @csrf
                                                @method('DELETE')
