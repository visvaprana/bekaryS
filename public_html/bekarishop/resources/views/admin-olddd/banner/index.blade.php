...
@section('title')
<title>{{ config('app.name') }} | Manage Banner</title>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card card-primary banner-form">
                        @if ($errors->any())
                        ...
                        <form role="form" action="{{route('banner.store')}}" method="post"  enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" id="exampleInputEmail1" placeholder="Banner Title">
                                </div>


                                <div class="form-group">
                                    <label for="exampleInputEmail1">Subscribe Title</label>
                                    <input type="text" name="subscribe_title" class="form-control" id="exampleInputEmail1" placeholder="Subscribe Title">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="btn_txt" class="form-control" id="exampleInputEmail1">
                                </div>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <button data-id="{{$item->id}}" class="btn btn-primary  btn-sm editBanner mx-1" >
