        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card card-primary brand-form">
                        @if ($errors->any())
                        ...
                        <form role="form" action="{{route('brand.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="Brand Name">
                                </div>
                                ...
                                <div class="form-group mt-5">
                                    <label for="exampleInputEmail1"><span class="text-danger">Brand SEO</span></label>
                                </div>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <form action="{{URL::to('admin/brand/'.$item->id)}}" method="post">
                                                @csrf
                                                @method('DELETE')
